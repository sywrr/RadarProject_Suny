...
public class Global {
    ...
    public static final short RADAR_COMMAND_STOPBREATH = 0x0014;     //当探测到最终呼吸时停止探测呼吸目标
    public static final short RADAR_COMMAND_UPLOAD = 0x0015; // 上传雷达数据用于专家模式
    public static final short RADAR_COMMAND_STOP_UPLOAD = 0x16; // 停止上传雷达数据
    public static final short RADAR_COMMAND_SET_MULTI_MODE = 0x17;
    public static final short RADAR_COMMAND_SET_SINGLE_MODE = 0x18;
    public static final short RADAR_COMMAND_SET_TIME_WINDOW = 0X19;

    public static final short DETECT_RANGE_REPORT = 0x1100;
    public static final short DETECT_FINISHED = 0x1101;

    public static final short DETECT_NO_BREATH_RESULT = 0x1102;

    public static final short PACKET_FILE_HEAD = 4;

    public static final int PACKET_NETWORK = 9;
    public static final int PACKET_ACK = 3;
    public static final int PACKET_COMMAND = 5;
    public static final int PACKET_DATA = 11;
    public static final int PACKET_DETECT_RESULT = 2;
    public static final int PACKET_SYSTEM_STATUS = 10;
    public static final int PACKET_WAVE = 8;
    public static final short PACKET_START_DETECT_RESPONSE = 12;
    public static final short PACKET_STOP_DETECT_RESPONSE = 13;
    public static final short PACKET_BATTERY = 14;
    ...
    public static final String RESULT_DIRECTORY_NAME = "SJ6000探测数据";

    //各探测段显示刻度值位置在位图上对应的像素点
    public static int mScalePos[][] = {{170, 51}, {175, 68}, {180, 87}, {185, 106}, {190, 127},
                                       {195, 148}, {200, 167}, {205, 184}, {210, 202}, {215, 223},
                                       {220, 235}};

    public static int mResultPos[][] = {{35, 51}, {51, 68}, {68, 87}, {87, 106}, {106, 127},
                                        {127, 148}, {148, 167}, {167, 184}, {184, 202}, {202, 223},
                                        {223, 235}};
    ...
    public static Packet newPacket(int packetFlag, int packetType, int packetLength) {
        Packet pack = new Packet(packetType, packetLength);
        pack.setPacketFlag(packetFlag);
        return pack;
    }
}
