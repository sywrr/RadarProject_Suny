...
//	private VRulerGestureListener mListener;
     ...
     * Constructor
     */
    public VRulerView(Context context, AttributeSet attrs, int defStyle) {
     ...
     * Constructor
     */
    public VRulerView(Context context, AttributeSet attrs)
    {
            super(context, attrs);
            initData(context);
    }  
...
//		}
    ...
    public void drawTimeRuler(Canvas canvas)
    {
    	//////画出中心轴
      	...
      	//起始x,y坐标
      	xOrgPos = mWidePaint.getStrokeWidth()+mLeftspace;
      	yOrgPos = 0;
      	//终止x,y坐标
      	xPos = xOrgPos;
