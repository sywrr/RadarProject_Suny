...
//            bodymove = pos_val * 8;
//    }
//    if (result_data_breath[0] != 0xDDBB) {
//        result_data_breath[0] = 0xDDAA;
//    }
//    //result_data_breath[0]=0xDDAA;
//    result_data_breath[1] = 4;
//    result_data_breath[2] = pflag;
//    result_data_breath[3] = (short)bodymove /*pos_val*8*/; //
//    //result_data_breath[4]=0;
//    //result_data_breath[5]=0;  //上传呼吸信号判别结果
...
//      fw=fopen("E:\\数据\\搜救\\地下室\\20200731\\ltefile7.lte","rb");
