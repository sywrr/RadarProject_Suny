...
public class realTimeDIBView extends View {
    ...
    public void drawTimerangeRuler(Canvas canvas) {
        ...
        ////得到时窗值
        int timeWnd = ((MainActivity) mContext).mRadarDevice.getTimeWnd();
        int scanLen = ((MainActivity) mContext).mRadarDevice.getScanLen();
    ...
    public void drawDeeprangeRuler(Canvas canvas) {
        ...
        timeWnd = ((MainActivity) mContext).mRadarDevice.getTimeWnd();
        deepR = Global.DEFAULT_SCAN_RANGE;//(float)(timeWnd / 2 * 30 / Math.sqrt(10));
        short begpos = ((MainActivity) mContext).mRadarDevice.getBegPos();
        //2:
        float perDeep = 0.1f;
    ...
    private void drawSingleScan(Canvas canvas) {
        ...
        short[] dataBuf = ((MainActivity) mContext).mRadarDevice.getRecentScanDatas();
    ...
    public void drawDIB(Canvas canvas) {
        ...
        //
        int scanL;
        scanL = ((MainActivity) mContext).mRadarDevice.getScanLen();
        if (scanL < mDIBHeight)
            srcR.bottom = scanL;
    ...
    public Rect getDibShowRect() {
        ...
        //		HRulerView hRView = (HRulerView)(((LTDMainActivity)mParentActivity).findViewById(R
		//		.id.layoutHRuler));
    ...
    public void changeDatasToDIB(short[] buf, int length) {
        int mScanLen;
        mScanLen = ((MainActivity) mContext).mRadarDevice.getScanLen();
